class Admin::CompradorsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @comprador.save
        format.html { redirect_to admin_comprador_path(@comprador), notice: 'Comprador criado com sucesso' }
  ...
  def update
    respond_to do |format|
      if @comprador.update(comprador_params)
        format.html { redirect_to admin_comprador_path(@comprador), notice: 'Comprador atualizado com sucesso' }
  ...
  def destroy
    @comprador.destroy
    respond_to do |format|
      format.html { redirect_to admin_compradors_path, notice: 'Comprador removido com sucesso' }
